...
public class IncrementPower {
    ...
    /** Parameters for the incrementing of motor power in 25% increments for debug purposes (updated 10/10/25)
     * @param targetPower The power value for the given motor(s) to be incremented
     * @param negativeCheck A boolean used to check whether to add or subtract 25% of the power
     * @return Returns the final power to be applied to the given motor(s) as a double
     */
